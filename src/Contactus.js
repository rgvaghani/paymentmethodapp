    ...
    const [userData, setUserData] = useState({
      ...
      const submitData = async (event) => {
        ...
        if (firstName && lastName && phone && email && address && message) {
          const res = fetch(
            "https://payment-app-14bc4-default-rtdb.firebaseio.com/userDataRecords.json",
            {
              method: "POST",
              headers: {
        ...
        <section className="contactus-section">
            <div className="container">
                ...
                <p className="main-hero-para">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Amet deserunt dolores fuga quo repellat nemo!</p>
                <figure>
                        ...
                        <form method="POST">
                            ...
                            <div className="form-check form-checkbox-style">
                                ...
                                <label 
                                    ...
                                    I agree that the technical pay may 
                                    contact me at the email address and contact number.
                                </label>
                            </div>
