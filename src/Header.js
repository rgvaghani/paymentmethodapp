              ...
              <section className="container main-hero-container">
                ...
                d-flex justify-content-center flex-column align-items-start">
                    <h1 className="display-2">
                        Online payment made <br /> easy for you.</h1>
                        <p className="main-hero-para">
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                            Vitae temporibus dignissimos, voluptatibus animi laudantium obcaecati sunt natus consectetur omnis asperiores, 
                            ut a facere dicta distinctio pariatur incidunt adipisci neque. Iusto.
                        </p>
